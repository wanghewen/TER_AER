...
class TransactionEdgeAttributed(EdgeAttributed):
    # 24141 nodes, 141141 edges -> 24141 nodes, 165282 edges
    @classmethod
    ...
    def __init__(self, subset=None, no_node_features=False, initialized_instance=None, add_self_loop=True,
        ...
        if initialized_instance is None:
            super().__init__(name="TransactionEdgeAttributed", data_folder=data_folder,
...
if __name__ == "__main__":
    dataset = TransactionEdgeAttributed(subset="val", randomize_by_node=True)
    graph = dataset[0]
