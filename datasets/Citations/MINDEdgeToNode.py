...
class MINDEdgeToNode(EdgeToNode):
    ...
    def __init__(self, num_classes=10, subset=None, no_node_features=False, homo=True, aggregate=False, initialized_instance=None,
        ...
        super().__init__(name="MINDEdgeToNode", data_folder=data_folder, subset=subset,
...
if __name__ == "__main__":
    dataset = MINDEdgeToNode(subset="train", randomize_train_test=False,
