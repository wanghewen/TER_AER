...
from global_parameters import AMinerCountVectorizerDataFolder


class AMinerEdgeToNode(EdgeToNode):
    ...
    def __init__(self, num_classes=10, subset=None, no_node_features=False, homo=True, aggregate=False, initialized_instance=None,
        ...
        data_folder = AMinerCountVectorizerDataFolder
        super().__init__(name="AMinerEdgeToNode", data_folder=data_folder, subset=subset,
...
if __name__ == "__main__":
    dataset = AMinerEdgeToNode(subset="train", randomize_train_test=False,
